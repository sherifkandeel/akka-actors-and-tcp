...
//
//object OldEventStreamHandler {
//  final case class Ack(offset: Int) extends Tcp.Event
//
//  def props(connection: ActorRef, remote: InetSocketAddress): Props =
//    Props(classOf[OldEventStreamHandler], connection, remote)
//}
//
//class OldEventStreamHandler(connection: ActorRef, remote: InetSocketAddress)
//  extends Actor with ActorLogging {
//
//  import Tcp._
//  import OldEventStreamHandler._
//
...
//  def writing: Receive = {
//    case Received(data) =>
////      connection ! Write(Ack(currentOffset))
//      process(data)
//      buffer(data)
//
...
//    println(s"message received, batch size: ${message.split("\n").length}")
////    message.split("|").splitAt(1)._2.head match {
////      case "P" =>
////    }
////      TCPServer.handlers.foreach(p => p ! Write(ByteString("99|F|12|14")))
////    Write(data)
//  }
//}
